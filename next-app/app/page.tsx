    ...
    >
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <button
          ...
          className="text-surface-500 md:hidden"
        >
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex min-h-[calc(100vh-4rem)] flex-col items-center justify-center text-center">
          ...
          >
            <Link
              href="/auth"
              className="btn-primary group flex items-center justify-center gap-2 !px-8 !py-3.5 !text-base"
            >
              {t("landing.ctaStart")}
          ...
          >
            {stats.map((stat, i) => (
              ...
              >
                <div className="text-2xl font-bold text-surface-900 sm:text-3xl">
                  {stat.value}
                </div>
                ...
                <div className="mt-4 flex items-baseline gap-1">
                  <span
                    className={`text-4xl font-bold ${
                      plan.popular ? "text-primary-600" : "text-surface-900"
                    }`}
                  >
                  ...
                  <li key={n} className="flex items-start gap-3">
                    <Check
                      className={`mt-0.5 h-4 w-4 shrink-0 ${
                        plan.popular ? "text-primary-500" : "text-surface-300"
                      }`}
                    />
              ...
              <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
                {[
                  ...
                  <div key={metric.label} className="stat-card">
                    ...
                    <div className="mt-2 text-xl font-bold text-surface-900">
                      {metric.value}
                    </div>
                    <div className="mt-0.5 text-xs text-surface-400">
                      {t(`landing.${metric.label}`)}
                    </div>
                  </div>
                ))}
              </div>
                ...
                <div className="card">
                  ...
                  <div className="space-y-3">
                    {activities.map((a) => (
                      ...
                      >
                        <span className="text-sm text-surface-600">
                          {t(`landing.${a.titleKey}`)}
                        </span>
                        <span className="text-xs font-medium text-accent-600">
                          {t(`landing.${a.returnKey}`)}
                        </span>
                      </div>
                    ))}
                  </div>
